# Тестовый набор. Проверка состояния итогового счета при переводе денежных средств c/на счет клиента в приложении банка при использовании переменной int в коде.
